...
function AnimalFields({ values, setValues, livestockTypes, mobs, errors }) {
    return (
        <div className="space-y-3">
            <div>
                <input
...
function AnimalRow({ animal, canManage, livestockTypes, mobs }) {
    ...
    if (editing) {
        return (
            <div className="p-4 bg-green-50 space-y-3">
                <AnimalFields values={values} setValues={setValues} livestockTypes={livestockTypes} mobs={mobs} errors={errors} />
                <div className="flex gap-2">
                    <button onClick={save} className="flex-1 py-2 bg-green-600 text-white rounded-lg text-sm">Save</button>
